      ...
      <div className='pt-10 bg-gray-900 sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden'>
        <div className='relative bg-gray-800 px-6 sm:py-40 sm:px-12 lg:px-16'>
          ...
          <div className='relative max-w-3xl mx-auto flex flex-col items-center text-center'>
            ...
            <Link
              to='/signup'
              className='mt-8 w-full block bg-white border border-transparent rounded-md py-3 px-8 text-base font-medium text-gray-900 hover:bg-gray-100 sm:w-auto mb-4'
            >
              Get Started
            </Link>
          </div>
